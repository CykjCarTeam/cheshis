        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="demoTable">
                        ...
                        <div class="layui-inline ">
                            <input type="text" id="userid" name="userid" placeholder="请输入上传人" autocomplete="off"
                                   class="layui-input"  >
                        </div>
                    <div class="layui-inline ">
                        <input type="text" id="ntitle" name="nitlen" placeholder="请输入文档标题" autocomplete="off"
                               class="layui-input"  >
                    </div>
                        <div class="layui-inline">
                ...
                <div hidden="hidden" id="btn">
                    <button id="btn1"  class="layui-btn">下载</button>
                    <button class="layui-btn">审核通过</button>
                    <button class="layui-btn">审核不通过</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.use('table', function() {
        ...
        table.render({
            elem: '#utable'
            , height: 600
            , url: '<%=basePath%>admin/test!findwork.action' //数据接口
            , page: true //开启分页
            , limit:10
            , id: 'testReload'
            ...
            , cols: [[ //表头
                {field: 'wtitle', title: '文档标题', minWidth: 100}
                , {field: 'userid', title: '用户名', minWidth:150}
                , {field: 'wtime', title: '上传时间', minWidth: 60}
                , {field: 'typejf', title: '下载积分', minWidth: 60}
                , {field: 'typename', title: '文档类型', minWidth: 60}
                , {field: 'id', title: '操作', minWidth: 300,toolbar:'#btn'}
            ]]
        });
    //触发查询按钮
    var $ = layui.$, active = {
